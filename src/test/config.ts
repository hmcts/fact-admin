export const config = {
  ...
  TestHeadlessBrowser: process.env.TEST_HEADLESS ? process.env.TEST_HEADLESS === 'false' : true,
  TestSlowMo: 420,
  ...
  API_URL: process.env.API_URL || 'https://fact-api-aat.service.core-compute-aat.internal',
