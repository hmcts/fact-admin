...
async function loginWithRole(page, role, testInfo) {
  ...
  const targetAppUrlPattern = /.*localhost:3300.*/; // App base URL pattern after login
  ...
  if (hasLoggedIn[loginKey]) {
    ...
    const checkUrl = 'http://localhost:3300/courts'; // A simple page within your app that requires login
