...
When('I select Include closed courts', async () => {
 ...
 // const elementChecked = await I.seeCheckboxIsChecked(selector);
  I.grabValueFrom('#toggle-closed-courts-display');
  //I.grabAttributeFrom('#toggle-closed-courts-display');
  console.error('>>>>>>>>>>>>>' + await I.grabValueFrom('#toggle-closed-courts-display'));
    I.grabTextFrom('#toggle-closed-courts-display');
  //#numberOfCourts
  // if (I.dontSeeCheckboxIsChecked()) {
  //   I.click(selector);
  // }
});
//
