...
//
//   // I.amOnPage('https://material.angular.io/components/checkbox/examples');
//   // let actualStatus = await I.grabAttributeFrom({id: 'mat-checkbox-1-input'}, 'aria-checked');
//   // if (actualStatus === false) {
//   //   I.checkOption({id: 'mat-checkbox-1'});
//   // }
//
//   if (!element1Checked) {
