...
Feature: Opening Hours
  ...
  Scenario: Prevent blank entries being added
    ...
    And I click save
    Then An error is displayed for opening hours with summary "Hours is required for opening hours 1." and hours field message "Hours is required for opening hours 1"
